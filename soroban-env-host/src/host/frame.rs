...
use crate::{
    ...
    err,
    storage::StorageMap,
    xdr::{ContractCostType, Hash, HostFunction, HostFunctionType, ContractExecutable, ScVal},
...
impl Host {
    ...
    fn call_contract_fn(&self, id: &Hash, func: &Symbol, args: &[Val]) -> Result<Val, HostError> {
        ...
        match self.retrieve_contract_instance_from_storage(&storage_key)?.executable {
