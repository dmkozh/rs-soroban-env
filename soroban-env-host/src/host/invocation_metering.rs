                ...
                event: ContractEvent {
                    ...
                    body: V0(
                        ContractEventV0 {
                            ...
                            data: String(
                                ScString(
                                    StringM(invocation resource limits are exceeded: instructions: 1861299 > 10, memory bytes: 1163433 > 20, contract events size bytes: 800 > 50, contract data entry with key 'ContractInstance { contract_id: Hash(2e0ff7a55065f3a896723a964c3d9862a4722bfc77229fe4875f390ef2a0027e) }' size: 104 > 35, contract code entry with key 'Other(ContractCode(LedgerKeyContractCode { hash: Hash(1a2ee5a89dd2162a20e716b3e2de70a2d662480a9565350378661871bcf8e398) }))' size: 1840 > 45),
                                ),
                            ),
                        },
                    ),
