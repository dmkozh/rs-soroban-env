...
const RECORDING_MODE_INSTRUCTIONS_RANGE: f64 = 0.07;
...
fn test_wasm_upload_success_in_recording_mode() {
    ...
    expect!["1783238"].assert_eq(&res.resources.instructions.to_string());
...
fn test_wasm_upload_failure_in_recording_mode() {
    ...
    assert!(res.auth.is_empty());
    expect!["1095617"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_create_contract_success_in_recording_mode() {
    ...
    expect!["670287"].assert_eq(&res.resources.instructions.to_string());
...
fn test_create_contract_success_in_recording_mode_with_custom_account() {
    ...
    assert_eq!(res.auth, vec![cd.auth_entry]);
    expect!["1113371"].assert_eq(&res.resources.instructions.to_string());
...
fn test_create_contract_success_in_recording_mode_with_enforced_auth() {
    ...
    assert_eq!(res.auth, vec![cd.auth_entry]);
    expect!["673281"].assert_eq(&res.resources.instructions.to_string());
    expect!["104"].assert_eq(&res.resources.write_bytes.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
...
fn test_invoke_contract_with_storage_ops_success_in_recording_mode() {
    ...
    assert!(res.restored_rw_entry_ids.is_empty());
    expect!["830940"].assert_eq(&res.resources.instructions.to_string());
    ...
    expect!["946957"].assert_eq(&extend_res.resources.instructions.to_string());
    assert_eq!(
...
fn test_auto_restore_with_extension_in_recording_mode() {
    ...
    expect!["1604272"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_overwrite_in_recording_mode() {
    ...
    expect!["957997"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_new_entry_in_recording_mode() {
    ...
    let wasm_entry_size = cd.wasm_entry.to_xdr(Limits::none()).unwrap().len() as u32;
    expect!["1483870"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_expired_temp_entry_in_recording_mode() {
    ...
    expect!["1602577"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_recreated_temp_entry_in_recording_mode() {
    ...
    expect!["1604131"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
