...
fn test_simulate_upload_wasm() {
    ...
    expect!["2049994"].assert_eq(&res.simulated_instructions.to_string());
    ...
    assert_eq!(
        ...
        Some(SorobanTransactionData {
            ...
            resources: SorobanResources {
                ...
                instructions: res.simulated_instructions,
                disk_read_bytes: 0,
                write_bytes: res.transaction_data.as_ref().unwrap().resources.write_bytes,
            },
            resource_fee: res.transaction_data.as_ref().unwrap().resource_fee,
        })
    );
    expect!["1024997"].assert_eq(&res.simulated_memory.to_string());
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some(SorobanTransactionData {
            ...
            resources: SorobanResources {
                ...
                instructions: (res.simulated_instructions as f64 * 1.1) as u32,
                disk_read_bytes: 0,
                write_bytes: res.transaction_data.as_ref().unwrap().resources.write_bytes + 300,
            },
            resource_fee: res_with_adjustments
                .transaction_data
                .as_ref()
                .unwrap()
                .resource_fee,
...
fn test_simulation_returns_insufficient_budget_error() {
    ...
    expect!["106612"].assert_eq(&res.simulated_instructions.to_string());
    expect!["42554"].assert_eq(&res.simulated_memory.to_string());
...
fn test_simulation_returns_logic_error() {
    ...
    assert_eq!(res.transaction_data, None);
    expect!["150616"].assert_eq(&res.simulated_instructions.to_string());
    expect!["75308"].assert_eq(&res.simulated_memory.to_string());
    assert_eq!(res.modified_entries, vec![]);
}
...
fn test_simulate_create_contract() {
    ...
    assert!(res.contract_events.is_empty());
    assert!(res.diagnostic_events.is_empty());
    expect!["3175074"].assert_eq(&res.simulated_instructions.to_string());
    ...
    expect!["1587537"].assert_eq(&res.simulated_memory.to_string());
    assert_eq!(
        res.modified_entries,
        vec![LedgerEntryDiff {
            state_before: None,
...
fn test_simulate_invoke_contract_with_auth() {
    ...
    expect!["41640047"].assert_eq(&res.simulated_instructions.to_string());
    ...
    expect!["20820016"].assert_eq(&res.simulated_memory.to_string());
    assert_eq!(
        res.modified_entries,
        vec![LedgerEntryDiff {
            state_before: None,
...
fn test_simulate_invoke_contract_with_autorestore() {
    ...
    let contract_1_size = contracts[1]
        ...
        .unwrap()
        .len() as u32;
    expect!["12274019"].assert_eq(&res.simulated_instructions.to_string());
    expect!["6232679"].assert_eq(
        &res.transaction_data
            .as_ref()
            .unwrap()
            .resource_fee
    ...
    expect!["6137001"].assert_eq(&res.simulated_memory.to_string());
    assert_eq!(
        res.modified_entries,
        vec![
            LedgerEntryDiff {
...
fn test_simulate_extend_ttl_op() {
    ...
    .unwrap();
    expect!["280"].assert_eq(&no_op_extension.transaction_data.resource_fee.to_string());
    assert_eq!(
        no_op_extension,
        ExtendTtlOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resource_fee: no_op_extension.transaction_data.resource_fee,
            }
        }
    );
    ...
    assert_eq!(
        ...
        ExtendTtlOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resource_fee: extension_for_some_entries.transaction_data.resource_fee,
            }
        }
    );
    ...
    assert_eq!(
        ...
        ExtendTtlOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resource_fee: extension_for_all_entries.transaction_data.resource_fee,
            }
        }
    );
    ...
    assert_eq!(
        ...
        ExtendTtlOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resource_fee: extension_for_all_entries_with_adjustment
                    .transaction_data
                    .resource_fee,
            }
        }
...
fn test_simulate_restore_op() {
    ...
    expect!["280"].assert_eq(&no_op_restoration.transaction_data.resource_fee.to_string());
    assert_eq!(
        no_op_restoration,
        RestoreOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resource_fee: no_op_restoration.transaction_data.resource_fee,
            }
        }
    );
        ...
        RestoreOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resources: SorobanResources {
                    ...
                    instructions: 0,
                    disk_read_bytes: restoration_for_some_entries
                        .transaction_data
                        .resources
                        .disk_read_bytes,
                    write_bytes: restoration_for_some_entries
                        .transaction_data
                        .resources
                        .write_bytes,
                },
                resource_fee: restoration_for_some_entries.transaction_data.resource_fee,
            }
        }
    );
        ...
        RestoreOpSimulationResult {
            transaction_data: SorobanTransactionData {
                ...
                resources: SorobanResources {
                    ...
                    instructions: 0,
                    disk_read_bytes: extension_for_all_entries
                        .transaction_data
                        .resources
                        .disk_read_bytes,
                    write_bytes: extension_for_all_entries
                        .transaction_data
                        .resources
                        .write_bytes,
                },
